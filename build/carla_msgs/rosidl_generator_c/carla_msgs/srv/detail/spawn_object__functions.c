...
{
  carla_msgs__srv__SpawnObject_Request * msg = (carla_msgs__srv__SpawnObject_Request *)malloc(sizeof(carla_msgs__srv__SpawnObject_Request));
  if (!msg) {
    return NULL;
  }
...
carla_msgs__srv__SpawnObject_Request__Sequence__init(carla_msgs__srv__SpawnObject_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (carla_msgs__srv__SpawnObject_Request *)calloc(size, sizeof(carla_msgs__srv__SpawnObject_Request));
    if (!data) {
      return false;
    }
...
{
  carla_msgs__srv__SpawnObject_Request__Sequence * array = (carla_msgs__srv__SpawnObject_Request__Sequence *)malloc(sizeof(carla_msgs__srv__SpawnObject_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  carla_msgs__srv__SpawnObject_Response * msg = (carla_msgs__srv__SpawnObject_Response *)malloc(sizeof(carla_msgs__srv__SpawnObject_Response));
  if (!msg) {
    return NULL;
  }
...
carla_msgs__srv__SpawnObject_Response__Sequence__init(carla_msgs__srv__SpawnObject_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (carla_msgs__srv__SpawnObject_Response *)calloc(size, sizeof(carla_msgs__srv__SpawnObject_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  carla_msgs__srv__SpawnObject_Response__Sequence * array = (carla_msgs__srv__SpawnObject_Response__Sequence *)malloc(sizeof(carla_msgs__srv__SpawnObject_Response__Sequence));
  if (!array) {
    return NULL;
  }
