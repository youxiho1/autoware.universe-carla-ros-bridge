...
{
  carla_msgs__msg__CarlaWorldInfo * msg = (carla_msgs__msg__CarlaWorldInfo *)malloc(sizeof(carla_msgs__msg__CarlaWorldInfo));
  if (!msg) {
    return NULL;
  }
...
carla_msgs__msg__CarlaWorldInfo__Sequence__init(carla_msgs__msg__CarlaWorldInfo__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (carla_msgs__msg__CarlaWorldInfo *)calloc(size, sizeof(carla_msgs__msg__CarlaWorldInfo));
    if (!data) {
      return false;
    }
...
{
  carla_msgs__msg__CarlaWorldInfo__Sequence * array = (carla_msgs__msg__CarlaWorldInfo__Sequence *)malloc(sizeof(carla_msgs__msg__CarlaWorldInfo__Sequence));
  if (!array) {
    return NULL;
  }
