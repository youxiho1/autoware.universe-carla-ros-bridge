...
{
  carla_msgs__msg__CarlaCollisionEvent * msg = (carla_msgs__msg__CarlaCollisionEvent *)malloc(sizeof(carla_msgs__msg__CarlaCollisionEvent));
  if (!msg) {
    return NULL;
  }
...
carla_msgs__msg__CarlaCollisionEvent__Sequence__init(carla_msgs__msg__CarlaCollisionEvent__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (carla_msgs__msg__CarlaCollisionEvent *)calloc(size, sizeof(carla_msgs__msg__CarlaCollisionEvent));
    if (!data) {
      return false;
    }
...
{
  carla_msgs__msg__CarlaCollisionEvent__Sequence * array = (carla_msgs__msg__CarlaCollisionEvent__Sequence *)malloc(sizeof(carla_msgs__msg__CarlaCollisionEvent__Sequence));
  if (!array) {
    return NULL;
  }
