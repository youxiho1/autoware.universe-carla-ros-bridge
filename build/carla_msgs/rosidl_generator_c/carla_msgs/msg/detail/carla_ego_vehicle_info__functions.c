...
{
  carla_msgs__msg__CarlaEgoVehicleInfo * msg = (carla_msgs__msg__CarlaEgoVehicleInfo *)malloc(sizeof(carla_msgs__msg__CarlaEgoVehicleInfo));
  if (!msg) {
    return NULL;
  }
...
carla_msgs__msg__CarlaEgoVehicleInfo__Sequence__init(carla_msgs__msg__CarlaEgoVehicleInfo__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (carla_msgs__msg__CarlaEgoVehicleInfo *)calloc(size, sizeof(carla_msgs__msg__CarlaEgoVehicleInfo));
    if (!data) {
      return false;
    }
...
{
  carla_msgs__msg__CarlaEgoVehicleInfo__Sequence * array = (carla_msgs__msg__CarlaEgoVehicleInfo__Sequence *)malloc(sizeof(carla_msgs__msg__CarlaEgoVehicleInfo__Sequence));
  if (!array) {
    return NULL;
  }
