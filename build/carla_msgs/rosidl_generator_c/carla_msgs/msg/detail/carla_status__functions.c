...
{
  carla_msgs__msg__CarlaStatus * msg = (carla_msgs__msg__CarlaStatus *)malloc(sizeof(carla_msgs__msg__CarlaStatus));
  if (!msg) {
    return NULL;
  }
...
carla_msgs__msg__CarlaStatus__Sequence__init(carla_msgs__msg__CarlaStatus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (carla_msgs__msg__CarlaStatus *)calloc(size, sizeof(carla_msgs__msg__CarlaStatus));
    if (!data) {
      return false;
    }
...
{
  carla_msgs__msg__CarlaStatus__Sequence * array = (carla_msgs__msg__CarlaStatus__Sequence *)malloc(sizeof(carla_msgs__msg__CarlaStatus__Sequence));
  if (!array) {
    return NULL;
  }
