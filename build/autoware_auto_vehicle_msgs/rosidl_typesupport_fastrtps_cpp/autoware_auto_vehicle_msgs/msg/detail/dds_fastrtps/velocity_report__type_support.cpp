...
#include "autoware_auto_vehicle_msgs/msg/detail/velocity_report__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_auto_vehicle_msgs::msg::VelocityReport & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_auto_vehicle_msgs::msg::VelocityReport & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const autoware_auto_vehicle_msgs::msg::VelocityReport *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_auto_vehicle_msgs::msg::VelocityReport *>(
    untyped_ros_message);
...
{
  return max_serialized_size_VelocityReport(full_bounded, 0);
}
...
{
  return &autoware_auto_vehicle_msgs::msg::typesupport_fastrtps_cpp::_VelocityReport__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_auto_vehicle_msgs, msg, VelocityReport)() {
  return &autoware_auto_vehicle_msgs::msg::typesupport_fastrtps_cpp::_VelocityReport__handle;
}
