...
bool autoware_control_msgs__msg__control__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_control_msgs.msg._control.Control", full_classname_dest, 42) == 0);
  }
  autoware_control_msgs__msg__Control * ros_message = _ros_message;
  {  // stamp
  ...
  {  // lateral
    ...
    if (!autoware_control_msgs__msg__lateral__convert_from_py(field, &ros_message->lateral)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // longitudinal
    ...
    if (!autoware_control_msgs__msg__longitudinal__convert_from_py(field, &ros_message->longitudinal)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * autoware_control_msgs__msg__control__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_control_msgs.msg._control");
  ...
  {  // lateral
    PyObject * field = NULL;
    field = autoware_control_msgs__msg__lateral__convert_to_py(&ros_message->lateral);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // longitudinal
    PyObject * field = NULL;
    field = autoware_control_msgs__msg__longitudinal__convert_to_py(&ros_message->longitudinal);
    if (!field) {
      return NULL;
    }
    {
