...
#include "autoware_auto_control_msgs/msg/detail/ackermann_lateral_command__rosidl_typesupport_fastrtps_c.h"
...
using _AckermannLateralCommand__ros_msg_type = autoware_auto_control_msgs__msg__AckermannLateralCommand;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _AckermannLateralCommand__ros_msg_type * ros_message = static_cast<const _AckermannLateralCommand__ros_msg_type *>(untyped_ros_message);
  // Field name: stamp
  {
  ...
  void * untyped_ros_message)
{
  ...
  _AckermannLateralCommand__ros_msg_type * ros_message = static_cast<_AckermannLateralCommand__ros_msg_type *>(untyped_ros_message);
  // Field name: stamp
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _AckermannLateralCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_control_msgs__msg__AckermannLateralCommand(
...
static size_t _AckermannLateralCommand__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_autoware_auto_control_msgs__msg__AckermannLateralCommand(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_AckermannLateralCommand = {
...
static rosidl_message_type_support_t _AckermannLateralCommand__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_AckermannLateralCommand,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_control_msgs, msg, AckermannLateralCommand)() {
  return &_AckermannLateralCommand__type_support;
}
