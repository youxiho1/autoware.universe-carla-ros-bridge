...
static size_t _AckermannControlCommand__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_autoware_auto_control_msgs__msg__AckermannControlCommand(
    full_bounded, 0);
}
