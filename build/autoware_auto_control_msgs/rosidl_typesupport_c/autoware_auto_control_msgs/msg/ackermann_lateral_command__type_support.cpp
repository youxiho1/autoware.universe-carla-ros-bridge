...
static const _AckermannLateralCommand_type_support_symbol_names_t _AckermannLateralCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_control_msgs, msg, AckermannLateralCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_auto_control_msgs, msg, AckermannLateralCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_auto_control_msgs, msg, AckermannLateralCommand)() {
  return &::autoware_auto_control_msgs::msg::rosidl_typesupport_c::AckermannLateralCommand_message_type_support_handle;
}
