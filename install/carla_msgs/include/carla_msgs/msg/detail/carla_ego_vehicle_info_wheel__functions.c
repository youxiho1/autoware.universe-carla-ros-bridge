...
{
  carla_msgs__msg__CarlaEgoVehicleInfoWheel * msg = (carla_msgs__msg__CarlaEgoVehicleInfoWheel *)malloc(sizeof(carla_msgs__msg__CarlaEgoVehicleInfoWheel));
  if (!msg) {
    return NULL;
  }
...
carla_msgs__msg__CarlaEgoVehicleInfoWheel__Sequence__init(carla_msgs__msg__CarlaEgoVehicleInfoWheel__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (carla_msgs__msg__CarlaEgoVehicleInfoWheel *)calloc(size, sizeof(carla_msgs__msg__CarlaEgoVehicleInfoWheel));
    if (!data) {
      return false;
    }
...
{
  carla_msgs__msg__CarlaEgoVehicleInfoWheel__Sequence * array = (carla_msgs__msg__CarlaEgoVehicleInfoWheel__Sequence *)malloc(sizeof(carla_msgs__msg__CarlaEgoVehicleInfoWheel__Sequence));
  if (!array) {
    return NULL;
  }
