...
{
  carla_msgs__msg__CarlaTrafficLightInfo * msg = (carla_msgs__msg__CarlaTrafficLightInfo *)malloc(sizeof(carla_msgs__msg__CarlaTrafficLightInfo));
  if (!msg) {
    return NULL;
  }
...
carla_msgs__msg__CarlaTrafficLightInfo__Sequence__init(carla_msgs__msg__CarlaTrafficLightInfo__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (carla_msgs__msg__CarlaTrafficLightInfo *)calloc(size, sizeof(carla_msgs__msg__CarlaTrafficLightInfo));
    if (!data) {
      return false;
    }
...
{
  carla_msgs__msg__CarlaTrafficLightInfo__Sequence * array = (carla_msgs__msg__CarlaTrafficLightInfo__Sequence *)malloc(sizeof(carla_msgs__msg__CarlaTrafficLightInfo__Sequence));
  if (!array) {
    return NULL;
  }
