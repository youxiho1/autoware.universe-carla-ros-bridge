...
{
  carla_msgs__msg__CarlaLaneInvasionEvent * msg = (carla_msgs__msg__CarlaLaneInvasionEvent *)malloc(sizeof(carla_msgs__msg__CarlaLaneInvasionEvent));
  if (!msg) {
    return NULL;
  }
...
carla_msgs__msg__CarlaLaneInvasionEvent__Sequence__init(carla_msgs__msg__CarlaLaneInvasionEvent__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (carla_msgs__msg__CarlaLaneInvasionEvent *)calloc(size, sizeof(carla_msgs__msg__CarlaLaneInvasionEvent));
    if (!data) {
      return false;
    }
...
{
  carla_msgs__msg__CarlaLaneInvasionEvent__Sequence * array = (carla_msgs__msg__CarlaLaneInvasionEvent__Sequence *)malloc(sizeof(carla_msgs__msg__CarlaLaneInvasionEvent__Sequence));
  if (!array) {
    return NULL;
  }
