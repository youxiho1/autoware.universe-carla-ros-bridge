...
{
  carla_msgs__msg__CarlaEgoVehicleStatus * msg = (carla_msgs__msg__CarlaEgoVehicleStatus *)malloc(sizeof(carla_msgs__msg__CarlaEgoVehicleStatus));
  if (!msg) {
    return NULL;
  }
...
carla_msgs__msg__CarlaEgoVehicleStatus__Sequence__init(carla_msgs__msg__CarlaEgoVehicleStatus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (carla_msgs__msg__CarlaEgoVehicleStatus *)calloc(size, sizeof(carla_msgs__msg__CarlaEgoVehicleStatus));
    if (!data) {
      return false;
    }
...
{
  carla_msgs__msg__CarlaEgoVehicleStatus__Sequence * array = (carla_msgs__msg__CarlaEgoVehicleStatus__Sequence *)malloc(sizeof(carla_msgs__msg__CarlaEgoVehicleStatus__Sequence));
  if (!array) {
    return NULL;
  }
