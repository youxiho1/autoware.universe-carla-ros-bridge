...
{
  carla_msgs__msg__CarlaWeatherParameters * msg = (carla_msgs__msg__CarlaWeatherParameters *)malloc(sizeof(carla_msgs__msg__CarlaWeatherParameters));
  if (!msg) {
    return NULL;
  }
...
carla_msgs__msg__CarlaWeatherParameters__Sequence__init(carla_msgs__msg__CarlaWeatherParameters__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (carla_msgs__msg__CarlaWeatherParameters *)calloc(size, sizeof(carla_msgs__msg__CarlaWeatherParameters));
    if (!data) {
      return false;
    }
...
{
  carla_msgs__msg__CarlaWeatherParameters__Sequence * array = (carla_msgs__msg__CarlaWeatherParameters__Sequence *)malloc(sizeof(carla_msgs__msg__CarlaWeatherParameters__Sequence));
  if (!array) {
    return NULL;
  }
