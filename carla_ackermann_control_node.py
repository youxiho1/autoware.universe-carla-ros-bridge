...
class CarlaAckermannControl(CompatibleNode):
    ...
    def run_speed_control_loop(self):
        ...
        if self.info.target.speed > 0 and self.info.target.speed < 1 and self.info.target.accel > 0:
            self.info.status.speed_control_activation_count = 0
    ...
    def run_accel_control_loop(self):
        ...
        # print('pedal_targegt = ' + str(self.info.status.accel_control_pedal_target))
        # print('pedal_delta = ' + str(self.info.status.accel_control_pedal_delta))
    ...
    def update_drive_vehicle_control_command(self):
        ...
        #print()
        #print('lower_border = ' + str(self.info.status.throttle_lower_border))
        #print('upper_border = ' + str(self.info.status.brake_upper_border))
        # print('target = ' + str(self.info.status.accel_control_pedal_target))
